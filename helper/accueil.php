    ...
    <div class="row">
        <div class="search form-center">
            <form class="formulaire" action="../helper/research.php" method="POST">
                ...
                <button type="submit" name="rechercher" class="btn btn-sm"><img src="../img/search.png"></button>
            </form>
        </div>
    </div>
</div>
...
<?php
    ...
    <div class="col-md-4">
        <div class="thumbnail">
            ...
            <div class="caption">
                <h4 class="pull-right"><?=$accueil[$i]->prix;?> <img src="../img/coin.png"></h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 product_content">
                            <h4>Vendeur: <?=$accueil[$i]->nom;?> <?=$accueil[$i]->prenom;?><span></span></h4>
                            <p><?=$accueil[$i]->description;?></p>
                            <h3 class="text"><?=$accueil[$i]->prix;?> <img src="../img/coin.png"></h3>
                            <div class="row">
                                <div class="col-xs-12">
                                    <p>Etat : <br>
