...
<h2 class="text-center nav-item">Ajout d'un utilisateur</h2>
<div class="badge-center text-center">
    <form action="../admin/adminaddprofil.php" method="POST">
        <br><br>
        ...
        <br><br>
        <div class="form-group form-center">
            <input type="text" class="form-control" name="credit" placeholder="Crédits">
        </div>
        <br><br>
        <div class="col-auto my-1">
