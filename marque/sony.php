        ...
        <div class="col-md-4">
            <div class="thumbnail">
                ...
                <div class="btn-ground text-center">
                    <button type="button" class="btn btn-primary" style="margin-bottom: 5px" data-toggle="modal" data-target="#product<?=$sony[$i]->idprod;?>_view"><i class="fa fa-search"></i>En savoir plus</button>
                    <?php
                    if($sony[$i]->dispo == true){
                        echo'<form action="../telephone/achat.php" method="post">
                        <input name="idprod" value="' . $sony[$i]->idprod . '" hidden>
